...
namespace DataProcessor
{
    internal class FileProcessor
    {
        ...
        private static readonly string ComplaetedDirectoryName = "complete";
        ...
        public void Process()
        {
            ...
            // check if the backup directory is exist
            ...
            File.Copy(InputFilePath,backupFilePath,true); // true : if exist over write
            ...
            {
                WriteLine($"ERROR: a file with the name {inProgressFilePath} is already being progressed");
                return;
            }
            ...
            string completedDirectoryPath = Path.Combine(rootDirectoryPath, ComplaetedDirectoryName);
            ...
            //completedFileName = Path.ChangeExtension(completedFileName, ".complete"); // change extension
            ...
            ////Directory.Delete(inProgressDirectoryPath,true); // true : recursively delete
